...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        TestUtilities.insertWeatherValues(this.mContext, values);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Datos incorrectos en la tabla [weather]", c, values);
    ...
    public long insertLocation() {
        ...
        TestUtilities.validateCurrentRecord("Datos incorrectos en la tabla [location]",c,values);
